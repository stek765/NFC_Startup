...
export function CategoryTabs({
  ...
  return (
    <div className="relative">
      <div ref={containerRef} className="flex gap-7 overflow-x-auto overscroll-x-contain px-6 py-4">
      ...
      <div
        ...
        style={{ background: 'linear-gradient(90deg, transparent 0%, var(--color-bg) 90%)' }}
      />
    </div>
  );
}
