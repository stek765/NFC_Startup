...
export const ui: Record<Lang, UiStrings> = {
  it: {
    ...
    menuHint: 'Spunta i piatti che ti tentano: li ritrovi nella tua lista, senza risfogliare il menu ogni volta.',
    gotIt: 'Ho capito',
  ...
  en: {
    ...
    menuHint: "Tick the dishes you fancy: they'll be in your list, no flipping back through the menu.",
    gotIt: 'Got it',
  ...
  de: {
    ...
    menuHint: 'Haken Sie an, was Sie reizt: alles landet in Ihrer Liste — ohne erneutes Blättern.',
    gotIt: 'Verstanden',
